...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-[#07060a] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16" data-reveal>
          <div className="inline-block mb-4">
            <span className="text-sm section-chip px-3 py-1 rounded-full">Contact</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Let&apos;s Build Something Premium</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div data-reveal data-reveal-delay="80">
            ...
            <div className="space-y-6">
              <div className="flex items-center rounded-2xl p-4 border border-white/10 bg-white/[0.03]">
                ...
                <div>
                  ...
                  <p className="text-gray-300">abdulrahmanchohan4181@gmail.com</p>
                </div>
              </div>
