        ...
        <div className="rounded-xl p-8 lg:p-12 bg-gradient-to-br from-black/50 to-black/30 border border-white/5 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1" data-reveal>
            ...
            <div className="flex items-center gap-4">
              <button onClick={() => jumpTo('contact')} className="px-5 py-3 rounded-full font-semibold btn-primary">Launch Now</button>
              <button onClick={() => jumpTo('pricing')} className="px-4 py-2 rounded-full btn-secondary">View Plans</button>
            </div>
          </div>

          <div className="w-full md:w-96" data-reveal data-reveal-delay="120">
